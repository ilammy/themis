...
interface LibThemisModule extends EmscriptenModule {
  ...
  export type LibThemisModule = typeof LibThemisModule

  declare const libthemisFn: (config: {onRuntimeInitialized: () => void, locateFile?: () => string}) => LibThemisModule;

  export default libthemisFn
