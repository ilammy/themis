...
- **WebAssembly**
  ...
  - **Deprecations**
    ...
    - <a id="0.14.0-wasm-themis-require-deprecated">Imports with `require()` are deprecated and will not be supported in the next release</a> ([#FILL-ME-IN](https://github.com/cossacklabs/themis/pull/FILL-ME-IN)).
